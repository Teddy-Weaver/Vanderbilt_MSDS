...
```{r feature_percent_services_subscribed}
...
```{r feature_monthly_charge_per_service}
...
# Test -- Customers must subscribe to at least 1 service.
# Dollars / serivce should be greater than the (minimum monthly charge in the data) / 8
# Dollars / serivce should be less than the maximum monthly charge in the data
telco_churn_clean %>% 
  assert(within_bounds(min(telco_churn_clean$monthly_charges)/8, 
                        max(telco_churn_clean$monthly_charges)
                       ), 
